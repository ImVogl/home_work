...
Для сравнения для KNN RMSE на тестовой выборке составила 433, а R² 0.65.
В этой связи дальнейшее исследование будет проводиться на модели KNN.
Согласно пункту четыре, нужно вывести MAE, RMSE, R², полученные при обучении модели на тестовой выборке.
Выведем эти значения и сохраним скорректированные и преобразованные значения в отдельный файл.
"""

print(f'RMSE: {trainers["KNN"].rmse["test"]}')
print(f'R²: {trainers["KNN"].r2_score["test"]}')
print(f'MAE: {trainers["KNN"].mae["test"]}')
